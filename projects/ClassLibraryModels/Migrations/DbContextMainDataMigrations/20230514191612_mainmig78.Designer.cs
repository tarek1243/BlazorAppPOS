...
namespace ClassLibraryModels.Migrations.DbContextMainDataMigrations
{
    ...
    [Migration("20230514191612_mainmig78")]
    partial class mainmig78
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorAppSales.Data.Company", b =>
                {
                    ...
                    b.Property<string>("ReceiptFooter1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReceiptFooter2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReceiptFooter3")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReceiptHeader1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReceiptHeader2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReceiptHeader3")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BlazorAppSales.Data.RelatedProduct", b =>
                {
                    ...
                    b.HasIndex("Parent_ProductId");

                    b.HasIndex("Related_ProductId");

                    b.ToTable("Pos_RelatedProducts");
                });
            ...
            modelBuilder.Entity("ClassLibraryModels.InventoryTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Pos_InventoryTransaction");
                });

            modelBuilder.Entity("ClassLibraryModels.Site", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassLibraryModels.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassLibraryModels.InventoryTransaction", b =>
                {
                    ...
                    b.HasOne("ClassLibraryModels.Site", "Site")
                        .WithMany("InventoryTransactions")
                        .HasForeignKey("SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClassLibraryModels.Warehouse", "Warehouse")
                        .WithMany("InventoryTransactions")
